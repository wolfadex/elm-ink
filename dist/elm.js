...
var $author$project$Main$phrases = _Utils_Tuple2(
	'We\'re glad you could join us :)',
	_List_fromArray(
		['Get ready for some fun!', 'An Elm package for TUIs']));
...
var $author$project$Main$init = function (initialSeed) {
	var _v0 = $author$project$Main$phrases;
	var first = _v0.a;
	var rest = _v0.b;
	var _v1 = A2(
...
var $author$project$Ink$inkNode = function (suffix) {
	return $elm$html$Html$node('elm-ink-' + suffix);
};
			...
			return A3(
				...
				_List_fromArray(
					[
						...
						'submit',
						A2($elm$json$Json$Decode$map, onInput, $elm$json$Json$Decode$string))
					]),
				_List_Nil);
		case 'InkColumn':
			var styles = ink.a;
...
var $author$project$Ink$view = F2(
	function (userView, model) {
		var res = userView(model);
		return {
			body: _List_fromArray(
				[
					$author$project$Ink$inkToHtml(res.body)
				]),
			title: res.title
		};
	});
var $author$project$Ink$program = function (config) {
...
var $author$project$Ink$Style$Background = {$: 'Background'};
var $author$project$Ink$Style$Color = F2(
	function (a, b) {
		return {$: 'Color', a: a, b: b};
	});
var $author$project$Ink$Style$setBacgroundColor = function (color) {
	return A2($author$project$Ink$Style$Color, $author$project$Ink$Style$Background, color);
};
var $author$project$Ink$Style$Foreground = {$: 'Foreground'};
		...
		body: A2(
			...
			_List_fromArray(
				[
					...
					'Hello!'),
					A2(
					$author$project$Ink$row,
					_List_Nil,
					_List_fromArray(
						[
							A2($author$project$Ink$text, _List_Nil, 'Welcome to '),
							A2(
							$author$project$Ink$text,
							_List_fromArray(
								[
					...
					A2($author$project$Ink$text, _List_Nil, model.phrase)
				])),
		title: 'Elm Ink!'
	};
};
var $author$project$Main$main = $author$project$Ink$program(
